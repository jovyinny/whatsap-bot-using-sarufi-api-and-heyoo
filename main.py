# This is extension of Sarufi-heyoo-blueprint using sarufi api
import os
import requests
import logging
...
login_url="https://api.sarufi.io/users/login"
creds={
  "username": os.environ["username"],
  "password": os.environ["password"]
}
headers = {"Content-Type": "application/json"}
token= requests.request("POST", login_url, json=creds, headers=headers).json()["token"]
...
def respond(mobile: str, message: str, message_type: str = "text"):
  ...
  """
  conversation_url="https://api.sarufi.io/conversation/whatsapp"
  payload={
    "chat_id": mobile,
  ...
  response = (requests.request("POST", conversation_url, json=payload, headers=headers).json())
